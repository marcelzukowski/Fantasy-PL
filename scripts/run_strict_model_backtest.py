...
from fpl_engine.current_history import reconcile_current_targets_with_known_history
...
BACKTEST_SIMULATIONS_PER_FIXTURE = 32
...
def run(
    ...
    for gw in sorted(snapshots):
        ...
        current_states, history_matches = reconcile_current_targets_with_known_history(
            current_states,
            match_rows,
