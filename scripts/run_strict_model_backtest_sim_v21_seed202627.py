...
def run(
    ...
    simulator = FixtureSimulatorV21(historical_scoring_engine, SimulationConfig(
    ...
    projection_metadata = ExperimentMetadata(
        ...
        model_versions=("team_strength_v1", "minutes_hurdle_v1",
                        ...
                        FixtureSimulatorV21.VERSION, "projection_builder_v1"),
    ...
    convergence_configuration = {
        ...
        "model_versions": ["coherent_assists_v2" if use_assist_v2 else "events_v1",
                           FixtureSimulatorV21.VERSION, "projection_builder_v1", "optimizer_v2"],
    ...
    report = {
        ...
        "candidate_mode": (
            ...
            else "SIM_V21_DISTRIBUTION_PRESERVING_512"
        ),
    ...
    output = root / "data" / "processed" / "backtests" / "strict" / season / "simulator_ab" / "v21_512_seed202627"
